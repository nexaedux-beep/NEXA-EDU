...
const ar: Dict = {
  ...
  "prog.pageDesc": "التخصصات المميزة",
  ...
  "video.desc": "اكتشف بيئتك الدراسية المستقبلية",
  ...
  "about.desc":
    "نيكسا التعليمية مكتب استشارات ووكيل معتمد مقره إسطنبول، نرافق الطلبة الدوليين في رحلتهم الجامعية في تركيا وقبرص الشمالية: اختيار التخصص، التقديم، الخصومات، التأشيرة، السكن والاستقبال في المطار.",
...
const en: Dict = {
  ...
  "video.title": "Discover Your Future Study Destination",
  "video.desc": "Explore Türkiye's leading private universities, vibrant student life, and modern campuses through an immersive visual experience",
