...
const ar: Dict = {
  ...
  "svc.badge": "خدماتنا",
  "svc.title": "خدمات الطلاب في تركيا وقبرص",
  "svc.desc": "نرافقك بعد القبول أيضاً: معادلة الشهادات، الإقامة الطلابية، والسكن — بإجراءات واضحة ومتابعة كاملة",
  "svc.pageTitle": "خدماتنا للطلاب الدوليين",
  "svc.pageDesc": "فريق مختص يتولى عنك الإجراءات الرسمية في تركيا: معادلة الشهادة الثانوية، معادلة الشهادات الجامعية، الإقامة الطلابية، والسكن الطلابي",
  "svc.steps": "خطوات الإنجاز",
  "svc.documents": "الأوراق المطلوبة",
  "svc.duration": "المدة المتوقعة",
  "svc.cta": "اطلب هذه الخدمة",
  "svc.all": "استعرض كل الخدمات",
  "prog.prev": "السابق",
  "prog.next": "التالي",
  ...
  "video.title": "اكتشف بيئتك الدراسية المستقبلية",
  "video.desc": "جولة بصرية تمنحك لمحة عن المدن الجامعية والحياة الأكاديمية التي تنتظرك في تركيا وقبرص الشمالية.",
  ...
  "hero.desc":
    "نقود رحلتك التعليمية من أول استشارة إلى أول يوم دراسي، عبر حلول متكاملة وخدمات احترافية تلبي احتياجات الطلاب الدوليين في تركيا وشمال قبرص",
  "hero.cta1": "استعرض الجامعات",
  "hero.cta2": "تحدّث مع مستشارك\n",
  ...
  "about.desc":
    "نيكسا التعليمية شركة استشارات ووكيل قبولات معتمدة مقرها إسطنبول، نرافق الطلبة الدوليين في رحلتهم الجامعية في تركيا وقبرص الشمالية: اختيار التخصص، التقديم، الخصومات، التأشيرة، السكن والاستقبال في المطار",
  ...
  "uni.desc": "استكشف مجموعة واسعة من الجامعات الخاصة المعتمدة في تركيا وقبرص الشمالية، واختر الجامعة والتخصص والمدينة والخصم الأنسب لك.",
  ...
  "offers.desc":
    "منح وخصومات على رسوم الجامعات الخاصة في تركيا وقبرص الشمالية. تُحدَّث العروض أولاً بأول — تواصل معنا لمعرفة العرض المناسب لملفك",
  "offers.empty.title": "عروض جديدة قريباً",
  "offers.empty.desc": "سيتم نشر تفاصيل العروض هنا فور توفرها",
  ...
  "footer.tagline": "وكيل معتمد لأفضل الجامعات الخاصة في تركيا وقبرص الشمالية",
...
const en: Dict = {
  ...
  "svc.title": "Student services in Türkiye & Cyprus",
  "svc.desc": "We stay with you after admission too: degree equivalency, student residence and housing — clear steps, full follow-up",
  "svc.pageTitle": "Services for international students",
  "svc.pageDesc": "A dedicated team handles the official procedures in Türkiye for you: high-school equivalency, university degree recognition, student residence permit and housing",
  "svc.steps": "How it works",
  "svc.documents": "Required documents",
  "svc.duration": "Expected duration",
  "svc.cta": "Request this service",
  "svc.all": "Browse all services",
  "prog.prev": "Previous",
  "prog.next": "Next",
  ...
  "video.title": "Discover your future study environment",
  "video.desc": "A visual journey through Türkiye and Northern Cyprus, giving you a glimpse of university cities and academic life.",
  ...
  "hero.desc":
    "Your comprehensive destination for studying in Türkiye and Northern Cyprus. We provide professional educational consulting, university admissions, scholarships, and comprehensive student services, guiding you with confidence through every stage of your academic journey",
  "hero.cta1": "Browse universities",
  "hero.cta2": "Speak to your advisor",
  ...
  "about.desc":
    "NEXA Education is your trusted educational partner for studying in Türkiye and Northern Cyprus. We provide professional guidance, university admissions, scholarships, and comprehensive student services from your first consultation until you begin your academic journey",
  ...
  "uni.desc": "Explore leading accredited private universities across Türkiye and Northern Cyprus, with flexible options by city, program and scholarship.",
  ...
  "offers.empty.desc": "Details of the offer will be posted here as soon as they become available.",
  ...
  "footer.tagline": "Your trusted partner for university admissions and educational consulting in Türkiye and Northern Cyprus",
  "footer.rights": "© 2026 NEXA Education — All rights reserved",
