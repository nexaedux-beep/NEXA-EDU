    ...
    >
      <div className="relative h-[150px] w-full overflow-hidden">
        ...
        {program.level === "diploma" && (
          <span className="absolute top-3 rounded-full border border-border bg-card px-3 py-1 text-[10px] font-bold text-primary ltr:right-3 rtl:left-3">
            {lang === "ar" ? "دبلوم" : "Diploma"}
          </span>
        )}
      </div>
