            ...
            <fieldset className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label={t("apply.university")}>
                  <input list="nx-universities" className={fieldClass} value={values.university} maxLength={120} placeholder={t("apply.universityPh")} onChange={(e) => set("university", e.target.value)} />
                  <datalist id="nx-universities">
                    {uniNames.map((n) => (
